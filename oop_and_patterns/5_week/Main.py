...
def create_game(sprite_size, is_new):
    ...
    if is_new:
        hero = Objects.Hero(base_stats, Service.create_sprite(
            os.path.join("texture", "Hero0.png"), sprite_size))
        ...
        drawer = SE.GameSurface((640, 480), pygame.SRCALPHA, (0, 480),
                                ...
                                SE.InfoWindow((160, 600), (517, 0),
                                SE.Minimap((123, 123), pygame.SRCALPHA, (50, 50),
        ...
        hero.sprite = Service.create_sprite(
            os.path.join("texture", f"Hero{hero.item_level}.png"), sprite_size)

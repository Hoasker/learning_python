...
class ProgressBar(ScreenHandle):
    ...
    def draw(self, canvas):
        ...
        self.blit(font.render(f'{self.engine.hero.get_stats()["strength"]}', True, colors["black"]),
                  (480, 30))
        self.blit(font.render(f'{self.engine.hero.get_stats()["luck"]}', True, colors["black"]),
                  (480, 70))
...
class HelpWindow(ScreenHandle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.data.append(["", ""])
        self.data.append(['Tips:', 'Shadows are a lot more powerful in darkness.'])
        self.data.append(['', 'Blacksmith can upgrade your equipment.'])
        self.data.append(['', 'It costs some gold.'])
